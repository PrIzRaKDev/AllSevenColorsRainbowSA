...
bool ToggleRainbow;
ThiscallEvent<AddressList<0x7178F0, H_CALL>, PRIORITY_BEFORE, ArgPickNone, void()> CMovingThings__Render_BeforeClouds;
float m_f2DNearScreenZ;
float m_f2DFarScreenZ;
float m_fRecipNearClipPlane;
int32_t m_bFlushSpriteBufferSwitchZTest;
...
void
RenderBufferedOneXLUSprite(float x, float y, float z, float w, float h, uint8_t r, uint8_t g, uint8_t b, int16_t intens, float recipz, uint8_t a)
{
...
const CRGBA RAINBOW_LINES_COLOR[]{
	{30, 0, 0, 255},    // Красный
	{30, 15, 0, 255},   // Оранжевый
	{30, 30, 0, 255},   // Желтый
	{10, 30, 10, 255},  // Зеленый
	{0,  30, 30, 255},    // Голубой
	{0,  0,  30, 255},   // Синий
	{30, 0, 30, 255}    // Фиолетовый
};
